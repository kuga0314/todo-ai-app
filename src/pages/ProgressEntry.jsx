 ...
 *  - 保存は actualTotalMinutes に加算 + その日のログ actualLogs.{YYYY-MM-DD} にも加算（将来の集計用）
 */
    ...
    try {
      const ops = targets.map(async (t) => {
        ...
        const cur = Number.isFinite(Number(t.actualTotalMinutes))
          ...
          : 0;
        // actualTotalMinutes を加算し、日別ログも累積
                ...
                return (
                  ...
                  >
                    <div style={{ minWidth: 0 }}>
                      ...
                      <div style={{ fontSize: 12, color: "#666", marginTop: 2, display: "flex", gap: 10 }}>
                        <span>締切: {t.deadline ? format(t.deadline, "M/d HH:mm") : "—"}</span>
                        <span>E: {t.E}分</span>
                        <span>実績: {t.A}分</span>
                    ...
                    <div style={{ textAlign: "right", color: "#333", fontVariantNumeric: "tabular-nums" }}>
                      今日の合計:{" "}
